...
GO
PRINT N'Rename refactoring operation with key  is skipped, element [dbo].[Table].[created] (SqlSimpleColumn) will not be renamed to created_at';
...
GO
PRINT N'Creating Default Constraint unnamed constraint on [dbo].[useraccounts]...';
